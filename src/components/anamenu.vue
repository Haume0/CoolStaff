<template>
    <div class="flex justify-center w-screen h-screen">
            <div class="absolute w-[344px] h-[96px] flex items-center left top-14">
            ...
            <ul class="absolute flex flex-wrap gap-x-[20px] gap-y-[10px] justify-center w-3/4 top-48">
                ...
                <div class="relative basis-60 min-w-[200px] min-h-[200px] bg-csside rounded-2xl h-56 border-solid border-[#444444] border-[2px] cshoverNO ease-in-out delay-75 duration-150">
